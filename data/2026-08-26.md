...
### [1] [Boot-and-Feedback Framework for Generalist-Expert Model Collaboration in Breast Ultrasound Diagnosis](https://arxiv.org/abs/2608.23974)
...
### [3] [The Blending Ratio Is Not Where the Performance Is: Diagnosing Prototype Blending for Few-Shot Adaptation of Vision-Language Models](https://arxiv.org/abs/2608.23634)
...
### [99] [The ISCSLP 2026 Real-World Audio-Visual Speech Enhancement Challenge](https://arxiv.org/abs/2608.23759)
...
### [100] [EmoTra-TTS: Smooth Intra-Utterance Emotion Transitions for Speech Synthesis](https://arxiv.org/abs/2608.23791)
...
### [101] [Preference Optimization for Non-Verbal Vocalization Synthesis](https://arxiv.org/abs/2608.24163)
...
### [102] [Array-Agnostic Ambisonics Encoding via Diffusion Posterior Sampling](https://arxiv.org/abs/2608.24558)
...
### [103] [Visually-Guided Spatial Audio Generation for $360^\circ$ In-the-Wild Speech Scenes](https://arxiv.org/abs/2608.24579)
...
### [104] [Investigating voiced and unvoiced regions of speech for audio deepfake detection](https://arxiv.org/abs/2608.24639)
...
### [105] [REDnet: Recursive Encoder and Decoder for Speech Separation under Unknown Number of Speakers and Variable Number of Microphones](https://arxiv.org/abs/2608.24659)
...
### [106] [EXAM$^2$: $\underline{Ex}tending$ $\underline{A}udio$ $Understanding$ $in$ $\underline{M}ultilingual$ $and$ $\underline{M}ultimodal$ $Analysis$](https://arxiv.org/abs/2608.23758)
...
### [107] [Don't Just Listen, Try Planning: Graph-based Retrieval-Generation Agent for Long-form Audio Meeting Understanding](https://arxiv.org/abs/2608.24048)
...
### [108] [On the Robustness of Audio Deepfake Detection under Audio Watermarking](https://arxiv.org/abs/2608.24159)
...
### [109] [CoSTALA: Compositional Spatio-Temporal Audio-Language Alignment via Multi-Grain Hierarchical Contrastive Learning](https://arxiv.org/abs/2608.24374)
...
### [110] [Receive Diversity for Differential Binary Noise Modulation](https://arxiv.org/abs/2608.23950)
...
### [111] [Physics-Informed WiFi Sensing for Robust 3D Human Pose Estimation in Mobile and Cross-Environment Settings](https://arxiv.org/abs/2608.23995)
...
### [112] [Impact of Optical Reconfigurable Intelligent Surfaces on Channel Estimation for VLC Systems](https://arxiv.org/abs/2608.24287)
...
### [113] [Sensor Drift Compensation via Olfactory system and Reservoir Computing](https://arxiv.org/abs/2608.24288)
...
### [114] [Predicting Only from Selected Evidence: A Tempered Product-of-Experts Bottleneck for Auditable EEG Diagnosis](https://arxiv.org/abs/2608.24377)
...
### [115] [EM-KalmanNet: Learned Expectation-Maximization for Adaptive Tracking in Partially Known, Block-Wise Time-Varying State-Space Models](https://arxiv.org/abs/2608.24404)
...
### [116] [Time-Window Noise2Noise: A Self-Supervised Method for Blind Denoising of Vibration and Impact Signals in Mechanical Systems](https://arxiv.org/abs/2608.24443)
...
### [117] [A Transformer for Joint Multi-Receiver Pilotless Wi-Fi Decoding](https://arxiv.org/abs/2608.24584)
...
### [118] [An Ultra-Compact Differential V-Band Power Amplifier Using EDMOS Transistors With 18.1 dBm P1dB and 21% PAE in 22nm FD-SOI CMOS](https://arxiv.org/abs/2608.24686)
...
### [119] [An Efficient W-/D-Band Power Amplifier in a 130 nm SiGe BiCMOS Process](https://arxiv.org/abs/2608.24687)
...
### [120] [Relativistic Cramér-Rao Bound Scaling for Device-Based and Device-Free Sensing](https://arxiv.org/abs/2608.24722)
...
### [121] [Rotatable Antenna Relaying: Joint Precoding and Antenna Pointing Design](https://arxiv.org/abs/2608.24798)
...
### [122] [Coherent Direct D-MIMO Localization](https://arxiv.org/abs/2608.24880)
