...
### [97] [AudioProcessBench: Benchmark for Identifying Process Errors in Audio-Grounded Reasoning](https://arxiv.org/abs/2606.09925)
...
### [98] [RespiraMFM: A Multimodal Foundation Model with Contrastive Audio-Language Alignment for Respiratory Disease Identification](https://arxiv.org/abs/2606.09966)
...
### [99] [Inside the Latent Flow: Causal Deciphering of Attention Dynamics in Audio Separation Foundation Models](https://arxiv.org/abs/2606.10046)
...
### [100] [Automated Pronunciation Evaluation for Korean Toddler Speech using Speech Diarization and Self-Supervised Learning](https://arxiv.org/abs/2606.10213)
...
### [101] [Dual-Branch Gated Fusion for Open-Set Audio Deepfake Source Tracing](https://arxiv.org/abs/2606.10223)
...
### [102] [Linguistically Augmented Audio Speech Data (LinguAS)](https://arxiv.org/abs/2606.10246)
...
### [103] [Towards Robust Arabic Speech Emotion Recognition with Deep Learning](https://arxiv.org/abs/2606.10278)
...
### [104] [ViP-VL: Vietnamese Self-supervised Speech Pretraining Model with Vector-Quantization Learning](https://arxiv.org/abs/2606.10360)
...
### [105] [KFC-KWS: Keyframe Fusion with CTC for User-Defined Keyword Spotting](https://arxiv.org/abs/2606.10365)
...
### [106] [Speech Meets ELF: Audio Conditional Continuous-Target Diffusion for Speech Recognition and Translation](https://arxiv.org/abs/2606.10368)
...
### [107] [Time-frequency localization of bird calls in dense soundscapes](https://arxiv.org/abs/2606.10407)
...
### [108] [Enhancing Multilingual LLM-based ASR with Mixture of Experts and Dynamic Downsampling](https://arxiv.org/abs/2606.10439)
...
### [109] [A Lightweight Dual-Factor Acoustic Authentication System via Cascaded GMM-DTW Architecture for Edge Computing](https://arxiv.org/abs/2606.10565)
*Yutong Zhang*
...
### [110] [ContextCodec: Content-Focused Context Guidance for Ultra-Low Bitrate Speech Coding](https://arxiv.org/abs/2606.10591)
...
### [111] [Overview of ESDD2: Environment-Aware Speech and Sound Deepfake Detection Challenge](https://arxiv.org/abs/2606.10791)
...
### [112] [RAT: Reference-Augmented Training for ASV Anti-Spoofing](https://arxiv.org/abs/2606.10908)
...
### [113] [Ethical and Technical Limits of Deepfake Speech Datasets](https://arxiv.org/abs/2606.10911)
...
### [114] [What Do Deepfake Speech Detectors Actually Hear?](https://arxiv.org/abs/2606.10912)
...
### [115] [Human Walking Sensing and Pose Estimation in the 6 GHz Band Using Amplitude and Phase CSI](https://arxiv.org/abs/2606.10048)
...
### [116] [Curved Beam Enabled Wireless Communications: Modeling, Analysis and Optimization](https://arxiv.org/abs/2606.10164)
...
### [117] [Optimal Illumination via Joint Movement and Phase Optimization for Movable Antenna-RIS Configuration](https://arxiv.org/abs/2606.10190)
...
### [118] [Fundamentals of NOMA in Low-Earth Orbit Coordinated Multi-Satellite Networks](https://arxiv.org/abs/2606.10301)
...
### [119] [Simplified Temporal Convolutional-Based Channel Estimation for a WiFi Vehicular Communication Channel](https://arxiv.org/abs/2606.10511)
...
### [120] [Complex VAE with Heavy-Tailed Likelihood for Radar Target Detection in Sea Clutter](https://arxiv.org/abs/2606.10540)
...
### [121] [Information Bottleneck Meets Quantization: Finite Rate Analysis and Optimal Designs](https://arxiv.org/abs/2606.10869)
...
### [122] [Personalized Deep Learning for Short-Term Forecasting of Impending Atrial Fibrillation from Continuous Wearable ECG Signals](https://arxiv.org/abs/2606.10900)
...
### [123] [Multi-Channel Soil Moisture Measurement: High Accuracy and Low Crosstalk Through Optical-Semiconductor Based Differential Sensing](https://arxiv.org/abs/2606.11020)
...
### [124] [DMT: Demographic Conditioning, Morphology-Enhanced Transformer for Cuffless Blood Pressure Estimation from PPG Signals](https://arxiv.org/abs/2606.11125)
...
### [125] [Pre-Fault Voltage Discrimination and Time-Domain Protection for Distribution Networks with Inverter-Based Resources](https://arxiv.org/abs/2606.11135)
...
### [126] [DeRA-MOS: Optimizing Text-to-Music Evaluation via Decoupled Listwise Ranking and Modality Alignment](https://arxiv.org/abs/2606.10010)
...
### [127] [LLM can Read Spectrogram: Encoder-free Speech-Language Modeling](https://arxiv.org/abs/2606.10231)
...
### [128] [ANCHOR: Autoregressive Non-intrusive Chunk-Ordered Refinement for Joint Multi-Resolution Speech Quality Modeling](https://arxiv.org/abs/2606.10233)
...
### [129] [SSL-GMMVC: Interpretable Voice Conversion via Locally Linear GMM Transforms in Self-Supervised Representation Space](https://arxiv.org/abs/2606.10317)
...
### [130] [Entropy-Aware Domain-Routed Mixture-of-Experts Speech-LLM Framework: A Case Study of Multi-Domain Child-Adult ASR](https://arxiv.org/abs/2606.10454)
...
### [131] [GC-LoRA: Gated Convolutional LoRA for Parameter-Efficient Acoustic Adaptation](https://arxiv.org/abs/2606.10464)
...
### [132] [Spatial-Omni: Spatial Audio Understanding Integration in Multimodal LLMs via FOA Encoding](https://arxiv.org/abs/2606.10738)
...
### [133] [Anchoring the Unknown: Open-Set Model Attribution via Proxy-Anchor Learning](https://arxiv.org/abs/2606.10758)
...
### [134] [Recovering the Zipfian Distribution in Unsupervised Term Discovery](https://arxiv.org/abs/2606.10781)
...
### [135] [Towards Deep Contextual Reasoning from Broad Descriptions for ASR with Speech-LLM via Metadata-Driven Reasoning Chains](https://arxiv.org/abs/2606.10838)
...
### [136] [Speech Encoder Fusion for LLM-based Automatic Speech Recognition](https://arxiv.org/abs/2606.10853)
*Jakob Poncelet,Hugo Van hamme*
...
### [137] [Phoneme-First Prediction for LLM-Based Speech Recognition](https://arxiv.org/abs/2606.10864)
*Jakob Poncelet,Hugo Van hamme*
...
### [138] [Optimizing 2D Input Representations and Sub-phase Fusion Strategies for Differential Diagnosis of Asthma and COPD Using CNN- and GRU-Based Networks](https://arxiv.org/abs/2606.10972)
