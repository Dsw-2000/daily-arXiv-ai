...
### [4] [TurboTalk: Progressive Distillation for One-Step Audio-Driven Talking Avatar Generation](https://arxiv.org/abs/2604.14580)
...
### [92] [HARNESS: Lightweight Distilled Arabic Speech Foundation Models](https://arxiv.org/abs/2604.14186)
...
### [93] [Who is Speaking or Who is Depressed? A Controlled Study of Speaker Leakage in Speech-Based Depression Detection](https://arxiv.org/abs/2604.14354)
...
### [94] [UniPASE: A Generative Model for Universal Speech Enhancement with High Fidelity and Low Hallucinations](https://arxiv.org/abs/2604.14606)
...
### [95] [Neuro-Oracle: A Trajectory-Aware Agentic RAG Framework for Interpretable Epilepsy Surgical Prognosis](https://arxiv.org/abs/2604.14216)
...
### [96] [Geo2Sound: A Scalable Geo-Aligned Framework for Soundscape Generation from Satellite Imagery](https://arxiv.org/abs/2604.14707)
...
### [97] [ControlFoley: Unified and Controllable Video-to-Audio Generation with Cross-Modal Conflict Handling](https://arxiv.org/abs/2604.15086)
...
### [98] [MCSC-Bench: Multimodal Context-to-Script Creation for Realistic Video Production](https://arxiv.org/abs/2604.15127)
...
### [99] [From Black Box to Glass Box: Cross-Model ASR Disagreement to Prioto Review in Ambient AI Scribe Documentation](https://arxiv.org/abs/2604.14152)
...
### [100] [Disentangled Dual-Branch Graph Learning for Conversational Emotion Recognition](https://arxiv.org/abs/2604.14204)
...
### [101] [VoxSafeBench: Not Just What Is Said, but Who, How, and Where](https://arxiv.org/abs/2604.14548)
...
### [102] [The Acoustic Camouflage Phenomenon: Re-evaluating Speech Features for Financial Risk Prediction](https://arxiv.org/abs/2604.14619)
...
### [103] [A Manual Bar-by-Bar Tempo Measurement Protocol for Polyphonic Chamber Music Recordings: Design, Validation, and Application to Beethoven's Piano and Cello Sonatas](https://arxiv.org/abs/2604.15278)
*Ignasi Sole*
...
### [104] [ClariCodec: Optimising Neural Speech Codes for 200bps Communication using Reinforcement Learning](https://arxiv.org/abs/2604.14654)
...
### [105] [Listen, Pause, and Reason: Toward Perception-Grounded Hybrid Reasoning for Audio Understanding](https://arxiv.org/abs/2604.14806)
...
### [106] [An Edge-Cloud Collaborative Architecture for Proactive Elderly Care: Real-Time Risk Assessment and Three-Level Emergency Response](https://arxiv.org/abs/2604.14154)
...
### [107] [On the Instantaneous Phase and Frequency Estimation of a Non-Stationary Multicomponent Signal. The JADE Algorithm](https://arxiv.org/abs/2604.14185)
...
### [108] [Closed-Form Analytical Solution for Effective Resistance in Finite 2D Anisotropic Resistor Grids via Jacobi Theta Functions](https://arxiv.org/abs/2604.14192)
*Ruichao Liu*
...
### [109] [Comprehensive Review of Doppler Shift Localization Methods: Advances, Limitations, and Research Opportunities](https://arxiv.org/abs/2604.14413)
*Rafal Szczepanik*
...
### [110] [Batch Effects In Brain Foundation Model Embeddings](https://arxiv.org/abs/2604.14441)
...
### [111] [ProtoAoA: Few-Shot Angle-of-Arrival Estimation using Prototypical Networks](https://arxiv.org/abs/2604.14476)
...
### [112] [Bridging Standardized Codebook and Site-Specific Beamforming: A Unified Limited-Feedback Framework](https://arxiv.org/abs/2604.14524)
...
### [113] [Beam Squinting Effects in Super Wideband Communication Systems](https://arxiv.org/abs/2604.14557)
...
### [114] [Low-Complexity Soft-Feedback Detector for AFDM Systems](https://arxiv.org/abs/2604.14666)
...
### [115] [ISAC with Backscattering RFID Tags: Beamforming and Codebook Design](https://arxiv.org/abs/2604.14689)
...
### [116] [Enhancing time-frequency resolution with optimal transport and barycentric fusion of multiple spectrogram](https://arxiv.org/abs/2604.15055)
...
### [117] [Optimal Robust Adaptive Beamforming for a General-Rank Signal Model via Equivalence of Maximin and Minimax SINR Problems](https://arxiv.org/abs/2604.14713)
...
### [118] [Temporal Cross-Modal Knowledge-Distillation-Based Transfer-Learning for Gas Turbine Vibration Fault Detection](https://arxiv.org/abs/2604.14766)
...
### [119] [An Open-Source Hardware-Aware Sub-THz Radio-Stripe Simulator](https://arxiv.org/abs/2604.14869)
...
### [120] [Impact of deployment on energy efficiency of sub-THz transmission](https://arxiv.org/abs/2604.14887)
...
### [121] [A Numerical and Experimental Evaluation of Microbubble Communication Using OpenFOAM](https://arxiv.org/abs/2604.14919)
...
### [122] [Ternary Noise Modulation](https://arxiv.org/abs/2604.15139)
...
### [123] [Eccentricity Confound in EEG-based Visual Attention Decoding from Gaze-Fixated Neural Tracking of Motion in Natural Videos](https://arxiv.org/abs/2604.15223)
...
### [124] [Physical Layer Security Performance of Pinching-Antenna Systems With In-Waveguide Attenuation](https://arxiv.org/abs/2604.15232)
