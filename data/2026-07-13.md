...
### [71] [Dual-BEATs: Unlocking Zero-Shot Stereo Audio Perception in Audio Large Language Models via Dithering](https://arxiv.org/abs/2607.08800)
...
### [72] [Tonnetz-Driven Graph Wedgelet for Harmonic Complexity Reduction in Music Scores](https://arxiv.org/abs/2607.08806)
...
### [73] [Clean2FX: Label-conditioned modeling for clean-to-effect guitar audio transformations](https://arxiv.org/abs/2607.08863)
...
### [74] [Optimal Transport-based Semantic Alignment for LLM-based Audio-Visual Speech Recognition](https://arxiv.org/abs/2607.09001)
...
### [75] [ReGen: Hierarchical Multi-Prompt Representation Generation for Efficient Waveform Diffusion Models](https://arxiv.org/abs/2607.09134)
...
### [76] [Event-Based Token Sequences for Audio-Conditioned Music-Game Level Modeling](https://arxiv.org/abs/2607.09095)
...
### [77] [Matched Generators for the Karhunen--Loève Transform: A Double-Commutator Eigenvalue Theory](https://arxiv.org/abs/2607.08788)
*Mitchell A. Thornton*
...
### [78] [A 2.4 GHz LC-VCO Fractional-N Phase Locked Loop Open-Source Design in 130-nm BiCMOS](https://arxiv.org/abs/2607.08852)
...
### [79] [Fast Pinching-Antenna Activation for AirComp](https://arxiv.org/abs/2607.08873)
...
### [80] [Every Sample Counts: Supervised Fine-Tuning of Language Models with Pointwise Constraints](https://arxiv.org/abs/2607.08968)
...
### [81] [Inter-frame Channel Prediction for Zak-OTFS](https://arxiv.org/abs/2607.09184)
...
### [82] [Multi-Domain Iterative Detection for Massive Connectivity in LEO Satellite Networks](https://arxiv.org/abs/2607.09212)
...
### [83] [Tensor-based Random Access for Ambient IoT Contention Resolution](https://arxiv.org/abs/2607.09331)
...
### [84] [Site Geometry and Calibration Uncertainties in Digital Twin-enabled Channel Estimation](https://arxiv.org/abs/2607.09334)
...
### [85] [Drone-Based Antenna Measurement System with Optimized Positioning and ASPIRE-Based NF-FF Transformation](https://arxiv.org/abs/2607.09361)
...
### [86] [On LLR Calculations for Soft-decision Decoding in Next-generation IM-DD Systems with Laser RIN](https://arxiv.org/abs/2607.09433)
...
### [87] [OAM-Enabled Holographic MIMO Communications with Stacked Intelligent Metasurfaces](https://arxiv.org/abs/2607.09479)
...
### [88] [Fused Constrained Policy Reuse Optimization for Wireless Resource Allocation](https://arxiv.org/abs/2607.09498)
...
### [89] [Symbol-Level Precoding for Continuous-Aperture ISAC Systems](https://arxiv.org/abs/2607.09610)
*Hongli Liu,Qiang Li*
...
### [90] [Phone Segmentation and Recognition through Phonological Activation Mapping](https://arxiv.org/abs/2607.09020)
...
### [91] [Technical Report for MERL's Real-TSE Challenge Submission](https://arxiv.org/abs/2607.09043)
