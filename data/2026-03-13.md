...
### [7] [FlashMotion: Few-Step Controllable Video Generation with Trajectory Guidance](https://arxiv.org/abs/2603.12146)
...
### [127] [Performance Bounds and Robust Filtering for LEO Inter-Satellite Synchronization under Cross-Epoch Doppler Coupling](https://arxiv.org/abs/2603.11280)
...
### [128] [RHOSI: Efficient Anti-Jamming Resource Allocation with Holographic Surfaces in UAV-enabled ISAC](https://arxiv.org/abs/2603.11362)
...
### [129] [Standard Condition Number-Based Detection for MIMO ISAC Systems under Noise Uncertainty](https://arxiv.org/abs/2603.11516)
...
### [130] [Exploiting Skyrmions in Free-Space Optical Communication](https://arxiv.org/abs/2603.11548)
...
### [131] [Learnable Template Matching Approach for Micro-Deformation Monitoring based on Integrated Sensing and Communication Platform](https://arxiv.org/abs/2603.11639)
...
### [132] [Machine Learning-Based Analysis of Critical Process Parameters Influencing Product Quality Defects: A Real-World Case Study in Manufacturing](https://arxiv.org/abs/2603.11666)
...
### [133] [Dimensional Scaling Laws for Continuous Fluid Antenna Systems](https://arxiv.org/abs/2603.11738)
...
### [134] [BER Analysis and Optimization for Continuous RIS-Enabled NOMA](https://arxiv.org/abs/2603.11739)
...
### [135] [On the Distribution of Matched Filtering with Continuous Aperture Arrays](https://arxiv.org/abs/2603.11740)
...
### [136] [Beyond the Limits of Rigid Arrays: Flexible Intelligent Metasurfaces for Next-Generation Wireless Networks](https://arxiv.org/abs/2603.11886)
...
### [137] [Indirect and Direct Multiuser Hybrid Beamforming for Far-Field and Near-Field Communications: A Deep Learning Approach](https://arxiv.org/abs/2603.11918)
...
### [138] [Array Geometry-Centric Axial Sidelobe Interference Analysis for Near-Field Multi-User MIMO](https://arxiv.org/abs/2603.12014)
...
### [139] [Simultaneous Multi-Modal Covert Communications: Analysis and Optimization](https://arxiv.org/abs/2603.12172)
...
### [140] [Multimodal Self-Attention Network with Temporal Alignment for Audio-Visual Emotion Recognition](https://arxiv.org/abs/2603.11095)
...
### [141] [Catalogue Grounded Multimodal Attribution for Museum Video under Resource and Regulatory Constraints](https://arxiv.org/abs/2603.11147)
...
### [142] [Stage-Adaptive Reliability Modeling for Continuous Valence-Arousal Estimation](https://arxiv.org/abs/2603.11468)
...
### [143] [OmniForcing: Unleashing Real-time Joint Audio-Visual Generation](https://arxiv.org/abs/2603.11647)
...
### [144] [Can LLMs Help Localize Fake Words in Partially Fake Speech?](https://arxiv.org/abs/2603.11205)
...
### [145] [Cough activity detection for automatic tuberculosis screening](https://arxiv.org/abs/2603.11241)
...
### [146] [Self-Speculative Decoding for LLM-based ASR with CTC Encoder Drafts](https://arxiv.org/abs/2603.11243)
...
### [147] [SEMamba++: A General Speech Restoration Framework Leveraging Global, Local, and Periodic Spectral Patterns](https://arxiv.org/abs/2603.11669)
...
### [148] [RAF: Relativistic Adversarial Feedback For Universal Speech Synthesis](https://arxiv.org/abs/2603.11678)
*Yongjoon Lee,Jung-Woo Choi*
...
### [149] [Affect Decoding in Phonated and Silent Speech Production from Surface EMG](https://arxiv.org/abs/2603.11715)
...
### [150] [ReDimNet2: Scaling Speaker Verification via Time-Pooled Dimension Reshaping](https://arxiv.org/abs/2603.11841)
...
### [151] [Acoustic-to-Articulatory Inversion of Clean Speech Using an MRI-Trained Model](https://arxiv.org/abs/2603.11845)
...
### [152] [Reconstruction of the Vocal Tract from Speech via Phonetic Representations Using MRI Data](https://arxiv.org/abs/2603.11847)
*Sofiane Azzouz,Pierre-André Vuissoz,Yves Laprie*
...
### [153] [Silent Speech Interfaces in the Era of Large Language Models: A Comprehensive Taxonomy and Systematic Review](https://arxiv.org/abs/2603.11877)
...
### [154] [Dr. SHAP-AV: Decoding Relative Modality Contributions via Shapley Attribution in Audio-Visual Speech Recognition](https://arxiv.org/abs/2603.12046)
...
### [155] [V2A-DPO: Omni-Preference Optimization for Video-to-Audio Generation](https://arxiv.org/abs/2603.11089)
...
### [156] [Uni-ASR: Unified LLM-Based Architecture for Non-Streaming and Streaming Automatic Speech Recognition](https://arxiv.org/abs/2603.11123)
...
### [157] [Fair-Gate: Fairness-Aware Interpretable Risk Gating for Sex-Fair Voice Biometrics](https://arxiv.org/abs/2603.11360)
...
### [158] [Continued Pretraining for Low-Resource Swahili ASR: Achieving State-of-the-Art Performance with Minimal Labeled Data](https://arxiv.org/abs/2603.11378)
...
### [159] [Edge-Cloud Collaborative Speech Emotion Captioning via Token-Level Speculative Decoding in Audio-Language Models](https://arxiv.org/abs/2603.11397)
...
### [160] [Resurfacing Paralinguistic Awareness in Large Audio Language Models](https://arxiv.org/abs/2603.11947)
...
### [161] [AnimeScore: A Preference-Based Dataset and Framework for Evaluating Anime-Like Speech Style](https://arxiv.org/abs/2603.11482)
...
### [162] [Toward Complex-Valued Neural Networks for Waveform Generation](https://arxiv.org/abs/2603.11589)
...
### [163] [Resonate: Reinforcing Text-to-Audio Generation via Online Feedback from Large Audio Language Models](https://arxiv.org/abs/2603.11661)
...
### [164] [Causal Prosody Mediation for Text-to-Speech:Counterfactual Training of Duration, Pitch, and Energy in FastSpeech2](https://arxiv.org/abs/2603.11683)
